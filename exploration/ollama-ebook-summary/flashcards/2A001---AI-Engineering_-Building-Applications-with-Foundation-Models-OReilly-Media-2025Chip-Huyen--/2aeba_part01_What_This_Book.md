# Flashcards: 2A001---AI-Engineering_-Building-Applications-with-Foundation-Models-OReilly-Media-2025Chip-Huyen--_processed (Part 1)
...
#### Differences Between Traditional ML Engineering and AI Engineering
...
#### Determining Longevity of AI Solutions
...
??x
When evaluating the longevity of an AI solution, consider whether it faces fundamental limitations or can be improved through better models. Use Lindy’s Law as an inference tool; technologies that have been around for a long time are likely to continue existing for a while longer.
---
...
??x
The start-simple approach begins with basic solutions to address a problem, then builds complexity step-by-step as needed. This ensures that each stage is well-understood before moving on to more intricate methods.
---
#### Consulting Experts
...
---
#### Book Overview: Purpose and Scope
...
??x
This book offers a framework for choosing appropriate tools and methods in AI development without delving into detailed tutorials. Its main goal is to help readers understand how to build successful applications by considering various factors and trade-offs.
---
...
??x
Chapter 2 focuses on significant design decisions such as the model's training data recipe (which includes the types of data used), architecture (the structure of the neural network), scaling (resource allocation during training and inference), and how these elements influence the model’s behavior, including response generation.
...
---
#### Key Concepts for Different Groups
...
??x
Readers who find certain sections overly technical can opt to skip those sections or skim through them. The author recommends staying informed but not getting bogged down by excessive detail, allowing readers to focus on areas relevant to their specific needs and interests.
...
---
#### Leveraging Foundation Models for Business Impact
...
??x
Later sections of the book cover how organizations can leverage foundation models to improve their bottom line. Key areas include strategies for building a capable AI engineering team, integrating AI into existing workflows, and aligning technological advancements with broader business goals.
...
#### Historical Context of AI Applications
