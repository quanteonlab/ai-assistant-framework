# Flashcards: ConcurrencyNetModern_processed (Part 34)
...
---
#### Using LINQ Aggregate with Agents
...
#### Stateful DataFlowAgent Concept
...
#### Parallel Word Counter Pipeline
...
#### Multi-Agent System for Word Counting
...
---
#### Two-Way Communication with Counter Agent
...
#### StatefulDataFlowAgent and Its Operations
...
#### TaskCompletionSource and Option Pattern Usage
...
---
#### Match Extension Method of the Option Type
...
#### TransformBlock for Compressing Chunks
...
#### Stateful Agent for Completing the Workflow
...
---
#### BufferBlock and TransformBlocks for Data Processing
...
---
#### Asynchronous Encryption Process
...
---
#### Asynchronous Ordered Agent for Decryption and Decompression
...
#### Compressor and Encryptor Workflow
...
#### Compressing and Encrypting Chunks
...
#### Decompression and Decryption Order
