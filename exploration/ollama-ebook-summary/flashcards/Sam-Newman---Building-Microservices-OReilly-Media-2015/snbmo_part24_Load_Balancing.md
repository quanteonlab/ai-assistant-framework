# Flashcards: Sam-Newman---Building-Microservices-OReilly-Media-2015_processed (Part 24)
...
This approach leverages a single database to serve data for various services but comes with high risk if that central point of failure occurs.
...
#### Managing Multiple Caches in Public Web Applications
