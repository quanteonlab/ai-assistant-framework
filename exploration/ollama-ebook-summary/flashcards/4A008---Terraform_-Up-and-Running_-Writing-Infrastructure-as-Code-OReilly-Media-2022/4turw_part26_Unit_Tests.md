# Flashcards: 4A008---Terraform_-Up-and-Running_-Writing-Infrastructure-as-Code-OReilly-Media-2022_processed (Part 26)

**Starting Chapter:** Unit Tests
...
#### Identifying Units in Terraform
...
#### Using Terratest for Testing Infrastructure
...
#### Getting ALB DNS Name from Terraform Outputs
...
#### Ensuring Correct Terratest Version
...
#### AWS Authentication for Automated Tests
...
#### Integration with WebServer Class
...
#### Count Parameter in Data Source Definitions
...
#### Input Variable for MySQL Configuration
...
#### Adding Environment Variable for Randomness
...
#### Passing Environment Variable to Module
...
#### Running Tests Against Same Folder in Parallel
