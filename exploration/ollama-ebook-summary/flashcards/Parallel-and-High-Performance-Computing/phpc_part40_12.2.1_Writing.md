# Flashcards: Parallel-and-High-Performance-Computing_processed (Part 40)

**Starting Chapter:** 12.2.1 Writing and building your first CUDA application

---

#### SYCL Overview and Intel’s Adoption
...
#### Features of a Native GPU Programming Language
...
#### Memory Handling in GPU Languages
...
#### CUDA vs. HIP: Low-Level Performance Options
...
#### Building Application with Makefile
...
#### Differences Between Old and New CMake Styles for CUDA Projects
...
#### Setting Compiler Flags in CMake
...
#### Add_executable Target in CMake
...
#### CUDA Architecture and Compilation Flags
