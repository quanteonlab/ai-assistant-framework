...
$$P(A) = \{\emptyset, \{1\}, \{2\}, \{3\}, \{1, 2\}, \{1, 3\}, \{2, 3\}, \{1, 2, 3\}\}$$??x
...
$$A \times B = \{(1, \text{,}), (1, \pi), (2, \text{,}), (2, \pi), (3, \text{,}), (3, \pi)\}.$$:p What is the definition of the Cartesian product $ A \times B$?
??x
