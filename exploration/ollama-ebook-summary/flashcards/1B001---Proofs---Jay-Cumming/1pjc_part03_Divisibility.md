...
$$gcd(12, 20) = 12k + 20\ell$$:p Find integers $ k $ and $\ell $ such that$gcd(12, 20) = 12k + 20\ell$.
??x
...
$$gcd(7, 15) = 7k + 15\ell$$:p Find integers $ k $ and $\ell $ such that$gcd(7, 15) = 7k + 15\ell$.
??x
...
$$a = mq + r$$where $0 \leq r < m $. The value of $ r $is the remainder when$ a $is divided by$ m$.
...
??x
Given that:
$$a \cdot 2a \cdot 3a \cdots (p-1)a \equiv 1 \cdot 2 \cdot 3 \cdots (p-1) \pmod{p},$$we can cancel out the terms $2, 3, \ldots, p-1$ on both sides using the modular cancellation law. This results in:
