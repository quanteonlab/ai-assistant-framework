...
- Filled square: $\Box $- Skinny and tall symbol:$\blacksquare$- Smiley face, cat drawing, spatula, or any creative symbol chosen by the author.
...
```latex
Proof: ...$\blacksquare$ End of Proof.
```
x??
...
- $-2 = 2 \times (-1)$-$0 = 2 \times 0 $-$2 = 2 \times 1 $ Odd numbers do not satisfy this condition. For instance, 3 is odd because it cannot be written in the form$2k$.
x??
...
- Commutative property: $a + b = b + a $ and$ab = ba $- Associative property:$(a + b) + c = a + (b + c)$,$(ab)c = a(bc)$- Distributive property:$ a(b + c) = ab + ac$
