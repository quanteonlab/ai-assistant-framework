# Flashcards: 2A005---Learn-Generative-AI-with-PyTorch-Manning-2024-Mark-Liu--_processed (Part 21)
...
#### Temperature Adjustment for Text Generation
...
#### Text Post-processing in `generate()`
...
#### Impact of Temperature and Top_k on Output
