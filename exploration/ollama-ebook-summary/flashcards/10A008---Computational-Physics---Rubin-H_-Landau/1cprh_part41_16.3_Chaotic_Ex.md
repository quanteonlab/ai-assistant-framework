...
$$\tau_g \approx -mgL(\theta - \frac{\theta^3}{6} + \frac{\theta^5}{120} - \cdots)$$where $ m $is the mass of the pendulum bob,$ L $ is the length of the pendulum, and $ g$ is the gravitational acceleration. This series expansion accounts for nonlinear effects in the gravitational restoring force.
