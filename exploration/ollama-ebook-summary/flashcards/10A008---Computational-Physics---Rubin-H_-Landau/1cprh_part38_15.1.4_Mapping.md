...
$$\mu_k \to \mu_{\infty} - c \delta^k, \quad \delta = \lim_{k \to \infty} \frac{\mu_k - \mu_{k-1}}{\mu_{k+1} - \mu_k}$$:p What is the significance of the Feigenbaum constants in bifurcation diagrams?
??x
