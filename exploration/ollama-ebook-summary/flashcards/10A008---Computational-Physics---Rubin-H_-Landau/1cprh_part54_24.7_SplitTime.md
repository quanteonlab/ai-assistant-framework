# Flashcards: 10A008---Computational-Physics---Rubin-H_-Landau_processed (Part 54)
...
#### Transmission Line and EM Waves
...
---
#### Phase Shifting After Plate Interaction
...
- A Gaussian pulse defined by $V(x, t=0) = 10 \exp(-x^2 / (2*0.1))$- The derivative condition is $\frac{\partial V}{\partial t} = 0$, meaning the pulse is initially static.
...
#### Effect of Zero Conductance and Resistance
...
#### Distortion of Rectangular Pulse in Transmission Line
...
---
#### Setting Up the Scene and Arrows
