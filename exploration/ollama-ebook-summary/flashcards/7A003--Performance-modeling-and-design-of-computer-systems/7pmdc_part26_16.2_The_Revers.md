...
$$E[T_{\text{CPU}}] = \frac{E[N_{\text{CPU}}}]{X_{\text{CPU}}} = \frac{3 \cdot \pi_{3,0} + 2 \cdot \pi_{2,1} + 1 \cdot \pi_{1,2}}{2.4} = \frac{3 \cdot 0.08 + 2 \cdot 0.22 + 1 \cdot 0.3}{2.4} = 0.41 \text{ sec}$$x??
