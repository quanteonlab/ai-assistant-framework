...
$$\hat{Z}(z) = \hat{X}(z) \cdot \hat{Y}(z)$$:p What is the question about this concept?
??x
...
$$E[X(X-1)(X-2) \cdots (X-k+1)]$$for $ k = 1, 2, 3, \ldots$.
...
$$P\{X < Y\} = \hat{\tilde{X}}(\lambda)$$:p What is the question about this concept?
??x
