# Flashcards: 2B004-Data-Governance_processed (Part 15)

**Starting Chapter:** How to Govern Data in Flight
...
Background context: The text discusses various strategies for data protection, ranging from not storing any data to making it publicly available. These choices depend on risk levels and regulatory requirements.

:p What are some of the data protection strategies mentioned?
??x
Some of the data protection strategies mentioned include:
- Not storing any data at all.
- Storing only aggregated data or a subset of the data.
- Tokenizing certain fields to protect sensitive information.
- Making the dataset publicly available, which is the least restrictive option.

These strategies vary in risk levels and are influenced by factors such as regulatory requirements and access control needs.
